...
This lab demonstrates Cross-Site Scripting (XSS) vulnerabilities in a safe, isolated environment.
...
The application will be available at `http://localhost:5023`
...
1. Understand how Cross-Site Scripting (XSS) vulnerabilities work
