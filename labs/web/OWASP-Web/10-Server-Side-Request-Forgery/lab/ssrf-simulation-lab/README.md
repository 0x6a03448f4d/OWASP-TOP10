# SSRF Lab: Ssrf Simulation Lab

## Overview

This lab demonstrates **SSRF** through a safe, educational environment.

## Vulnerability Demonstrated

**URL fetcher without validation (mock SSRF)**

## Learning Objectives

1. ✅ Understand ssrf vulnerabilities
...
- **[Overview](../../overview.md)**: Understand ssrf
