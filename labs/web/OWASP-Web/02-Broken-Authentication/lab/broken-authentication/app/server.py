"""
OWASP Top 10 Lab: Broken Authentication

EDUCATIONAL PURPOSE ONLY
This is a safe, isolated demonstration of Broken Authentication vulnerabilities.
"""
...
if __name__ == '__main__':
    print("=" * 60)
    print("OWASP Top 10 Lab: Broken Authentication")
    print("=" * 60)
    print("\nTest Accounts:")
