# Lab Instructions: Logging Failures

## Introduction

Welcome to the Logging Failures lab! This hands-on exercise will help you understand this vulnerability class.
...
```bash
cd OWASP-Web/Logging Failures/lab/*/
docker-compose up
```
...
### Task 2.1: Failed Login
1. Try logging in
2. Fail intentionally
3. Notice it's NOT logged
