# Security Misconfiguration Lab: Debug Mode Lab

## Overview

This lab demonstrates **Security Misconfiguration** through a safe, educational environment.

## Vulnerability Demonstrated

**DEBUG mode enabled exposing stack traces**

## Learning Objectives

1. ✅ Understand security misconfiguration vulnerabilities
...
- **[Overview](../../overview.md)**: Understand security misconfiguration
