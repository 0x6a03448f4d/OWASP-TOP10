# Injection Lab: Unsafe Query Lab

## Overview

This lab demonstrates **Injection** through a safe, educational environment.

## Vulnerability Demonstrated

**SQL Injection via string concatenation (mock demonstration)**

## Learning Objectives

1. ✅ Understand injection vulnerabilities
...
- **[Overview](../../overview.md)**: Understand injection
