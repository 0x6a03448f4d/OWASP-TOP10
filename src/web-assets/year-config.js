...
const OWASP_YEAR_CONFIG = {
    ...
    '2017': {
        ...
        mobile: {
            ...
            vulnerabilities: [
                { id: 'M01', number: 1, name: 'Improper Platform Usage', slug: 'improper-platform-usage' },
                { id: 'M02', number: 2, name: 'Insecure Data Storage', slug: 'insecure-data-storage' },
                { id: 'M03', number: 3, name: 'Insecure Communication', slug: 'insecure-communication' },
                { id: 'M04', number: 4, name: 'Insecure Authentication', slug: 'insecure-authentication' },
                { id: 'M05', number: 5, name: 'Insufficient Cryptography', slug: 'insufficient-cryptography' },
                { id: 'M06', number: 6, name: 'Insecure Authorization', slug: 'insecure-authorization' },
                { id: 'M07', number: 7, name: 'Client Code Quality', slug: 'client-code-quality' },
                { id: 'M08', number: 8, name: 'Code Tampering', slug: 'code-tampering' },
                { id: 'M09', number: 9, name: 'Reverse Engineering', slug: 'reverse-engineering' },
    ...
    '2021': {
        ...
        api: {
            ...
            vulnerabilities: [
                { id: 'API01', number: 1, name: 'Broken Object Level Authorization', slug: 'broken-object-level-authorization' },
                { id: 'API02', number: 2, name: 'Broken User Authentication', slug: 'broken-user-authentication' },
                { id: 'API03', number: 3, name: 'Excessive Data Exposure', slug: 'excessive-data-exposure' },
                { id: 'API04', number: 4, name: 'Lack of Resources & Rate Limiting', slug: 'lack-of-resources-rate-limiting' },
                { id: 'API05', number: 5, name: 'Broken Function Level Authorization', slug: 'broken-function-level-authorization' },
                { id: 'API06', number: 6, name: 'Mass Assignment', slug: 'mass-assignment' },
                { id: 'API07', number: 7, name: 'Security Misconfiguration', slug: 'security-misconfiguration' },
                { id: 'API08', number: 8, name: 'Injection', slug: 'injection' },
                { id: 'API09', number: 9, name: 'Improper Assets Management', slug: 'improper-assets-management' },
    ...
    '2025': {
        ...
        api: {
            ...
            version: '2023',
            vulnerabilities: [
                { id: 'API01', number: 1, name: 'Broken Object Level Authorization (BOLA)', slug: 'broken-object-level-authorization' },
                { id: 'API02', number: 2, name: 'Broken Authentication', slug: 'broken-authentication' },
                { id: 'API03', number: 3, name: 'Broken Object Property Level Authorization', slug: 'broken-object-property-level-authorization' },
                { id: 'API04', number: 4, name: 'Unrestricted Resource Consumption', slug: 'unrestricted-resource-consumption' },
                { id: 'API05', number: 5, name: 'Broken Function Level Authorization', slug: 'broken-function-level-authorization' },
                { id: 'API06', number: 6, name: 'Unrestricted Access to Business Flows', slug: 'unrestricted-access-to-sensitive-business-flows' },
                { id: 'API07', number: 7, name: 'Server-Side Request Forgery (SSRF)', slug: 'server-side-request-forgery' },
                { id: 'API08', number: 8, name: 'Security Misconfiguration', slug: 'security-misconfiguration' },
                { id: 'API09', number: 9, name: 'Improper Inventory Management', slug: 'improper-inventory-management' },
        ...
        mobile: {
            ...
            version: '2024',
            vulnerabilities: [
                { id: 'M01', number: 1, name: 'Improper Credential Usage', slug: 'improper-credential-usage' },
                { id: 'M02', number: 2, name: 'Inadequate Supply Chain Security', slug: 'inadequate-supply-chain-security' },
                { id: 'M03', number: 3, name: 'Insecure Authentication/Authorization', slug: 'insecure-authentication-authorization' },
                { id: 'M04', number: 4, name: 'Insufficient Input/Output Validation', slug: 'insufficient-input-output-validation' },
                { id: 'M05', number: 5, name: 'Insecure Communication', slug: 'insecure-communication' },
                { id: 'M06', number: 6, name: 'Inadequate Privacy Controls', slug: 'inadequate-privacy-controls' },
                { id: 'M07', number: 7, name: 'Insufficient Binary Protections', slug: 'insufficient-binary-protections' },
                { id: 'M08', number: 8, name: 'Security Misconfiguration', slug: 'security-misconfiguration' },
                { id: 'M09', number: 9, name: 'Insecure Data Storage', slug: 'insecure-data-storage' },
