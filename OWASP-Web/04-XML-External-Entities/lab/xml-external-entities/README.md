...
This lab demonstrates XML External Entities (XXE) vulnerabilities in a safe, isolated environment.
...
The application will be available at `http://localhost:5022`
...
1. Understand how XML External Entities (XXE) vulnerabilities work
