...
This lab demonstrates Insecure Deserialization vulnerabilities in a safe, isolated environment.
...
The application will be available at `http://localhost:5024`
...
1. Understand how Insecure Deserialization vulnerabilities work
