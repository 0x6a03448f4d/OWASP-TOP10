# Lab Instructions: Vulnerable and Outdated Components

## Introduction

Welcome to the Vulnerable and Outdated Components lab! This hands-on exercise will help you understand this vulnerability class.
...
```bash
cd OWASP-Web/Vulnerable and Outdated Components/lab/*/
docker-compose up
```
...
### Task 2.1: Check Components
1. View component versions
