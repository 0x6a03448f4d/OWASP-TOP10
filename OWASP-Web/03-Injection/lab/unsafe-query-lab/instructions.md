# Lab Instructions: Injection

## Introduction

Welcome to the Injection lab! This hands-on exercise will help you understand this vulnerability class.
...
### Task 2.1: Test Vulnerable Search
1. Enter a product name
2. Try adding SQL keywords
3. Observe the warnings

### Task 2.2: Test Secure Search
1. Use the secure endpoint
2. Notice parameterized queries
3. See why it's safe
