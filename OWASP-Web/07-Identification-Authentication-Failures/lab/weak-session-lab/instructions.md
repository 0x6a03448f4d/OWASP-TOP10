# Lab Instructions: Authentication Failures

## Introduction

Welcome to the Authentication Failures lab! This hands-on exercise will help you understand this vulnerability class.
...
```bash
cd OWASP-Web/Authentication Failures/lab/*/
docker-compose up
```
...
### Task 2.1: Login and Observe
1. Login with test credentials
2. Note the session ID
3. See it's predictable
